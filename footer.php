            ...
            <div class="row justify-content-between">
               ...
               <div class="col-sm-6 col-md-6 col-lg-3">
                  <div class="single-footer-widget footer_icon">
                     ...
                     <ul>
                        <li><a href="#"><i class="fas fa-mobile-alt"></i>+91 - 89618 19473</a></li>
                        <li><a href="#"><i class="far fa-envelope"></i>thepalefire2019@gmail.com</a></li>
                     </ul>
                  </div>
               </div>
               <div class="col-sm-6 col-md-6 col-lg-3">
                  <div class="single-footer-widget footer_2">
                     ...
                     <div class="form-wrap" id="mc_embed_signup">
                        <form target="_blank" action="" method="" class="form-inline">
                           ...
                           <button class="btn btn-default text-uppercase"><i class="far fa-paper-plane"></i></button>
